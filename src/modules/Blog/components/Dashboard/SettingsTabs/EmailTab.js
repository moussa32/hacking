...
const EmailTab = () => {
  ...
  const handleNewEmail = (e) => {
    ...
    if (userEmail.length === 0) {
      ...
      axios.post(`${dvbaseUrl}/api/v2/auth/users/reset_username/`, {
        "email": userEmail
      }).then((response) => {
        ...
        <div className="col-md-12">
          <form className="profile-settings" onSubmit={handleNewEmail}>
            <div className="form-group">
              <label htmlFor="email" className="mb-3">البريد الإلكتروني الجديد:</label>
            ...
            <button type="submit" className="btn btn-settings d-block mx-auto settings-submit-button">تغيير البريد الإلكتروني</button>
