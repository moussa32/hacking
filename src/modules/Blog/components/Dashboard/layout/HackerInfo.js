        ...
        <div className="container">
          <div className="row">
            <div className="col-md-7 mx-auto">
              ...
              <p className="hackerLocation text-white lead"><VscLocation /> {country}</p>
              <p className="hackerBio text-white lead">{bio}</p>
              <div className="row mx-auto">
                <div className="col-md-12">
                  {userTwitter ? (<a href={userTwitter} className="text-lightgreen hacker-social-icons"><FaTwitterSquare size='2.5rem' /></a>) : ''}
                  {userLinkedin ? (<a href={userLinkedin} className="text-lightgreen hacker-social-icons"><FaLinkedin size='2.5rem' /></a>) : ''}
                  {userGithub ? (<a href={userGithub} className="text-lightgreen hacker-social-icons"><FaGithub size='2.5rem' /></a>) : ''}
                </div>
              </div>
            </div>
          </div>
...
const mapStateToProps = ({ blogs }) => {
  ...
  return {
    avatar: blogs.userInfo.hacker.avatar,
