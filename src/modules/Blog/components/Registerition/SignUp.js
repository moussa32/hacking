...
import Confirmation from './EmailConfirmation';
                        ...
                        <form onSubmit={Registration}>
                            ...
                            <div className="form-row">
                                ...
                                <div className="form-group col-md-7">
                                    <input type="date" placeholder="تاريخ الميلاد" name="birthDate" className="form-control custom-input" id="dat" required onChange={onTyping} />
                            ...
                            <div className="form-group">
                                ...
                                <CountryDropdown value={signUpData.country} className="form-control custom-input" name="country" onChange={onSetCountry} />
