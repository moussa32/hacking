                ...
                <div className="row">
                    ...
                    <form>
                        <div className="form-row">
                            ...
                            <input type="text" className="form-control bg-dark text-white" id="firstName" required/>
                            </div>
                            <div className="form-group col-md-6">
                            <label for="secondName">الاسم الثاني</label>
                            <input type="text" className="form-control bg-dark text-white" id="secondName" required/>
                            </div>
                        </div>
                        ...
                        <fieldset className="form-group row">
                            ...
                            <div className="col-sm-10 d-flex justify-content-md-end">
                                <div className="form-check">
                                    ...
                                    <input className="form-check-input bg-dark gender-input" type="radio" name="female" id="femaleChose" value="female"/>
                                </div>
                                <div className="form-check">
                                    <label className="form-check-label mr-4" for="maleChose">
                                    ذكر
                                    </label>
                                    <input className="form-check-input bg-dark gender-input" type="radio" name="male" id="maleChose" value="male"/>
                                </div>
                            </div>
                        </fieldset>
                        <div className="form-row">
                            ...
                            <div className="form-group col-md-2">
                                <input type="number" min="1" max="31" placeholder="يوم" className="form-control bg-dark text-white" id="inputCity" required/>
                            </div>
                            <div className="form-group col-md-2">
                                <input type="number" min="1" max="12" placeholder="شهر" className="form-control bg-dark text-white" id="inputZip" required/>
                            </div>
                            <div className="form-group col-md-3">
                                <input type="number" min="1921" placeholder="سنة" className="form-control bg-dark text-white" id="inputZip" required/>
                            </div>
                        </div>
                        <div className="form-group">
                            <label for="exampleFormControlSelect1">الدولة</label>
                            <select className="form-control bg-dark text-white" id="exampleFormControlSelect1">
                            <option></option>
                        ...
                        <div className="form-group">
                            ...
                            <input type="password" className="form-control bg-dark text-white" id="re-password" required/>
                        </div>
                        <div className="form-group">
                        ...
                        <div className="form-group">
                            ...
                            <label className="form-check-label signup-checkbox-label" for="gridCheck1">
                                موافق على <Link to='/terms-of-use' className="signup-link">اتفاقية المستخدم</Link> و<Link to='/privacy-policy' className="signup-link">شروط الاستخدام</Link>
                            </label>
                    </div>
                        ...
                        <small className="text-center my-3 d-block">هل لديك حساب؟ <Link to='/login' className="signup-link">تسجيل الدخول</Link></small>
                    </form>
                    </div>
