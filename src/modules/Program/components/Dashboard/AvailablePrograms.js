...
import { getProgramAssetsTypeApi } from '../../../../api/ProgramAPI/ProgramAssetsTypeApi';
...
const AvailablePrograms = () => {
  ...
  const [currentPageBlogs,setCurrentPageBlogs] = useState(null);
  ...
  useEffect(() => {
    allAvailablePrograms
      ...
      getProgramAssetsTypeApi(localStorage.getItem('accessToken')).then((res) => console.log(res.data))
  }, [])
              ...
              <div className="bg-black">
                <div id="programs-slider" className="carousel slide my-4" data-ride="carousel">
                  <div className="carousel-inner">
                    ...
                    <div className="carousel-item">
                      <img src="https://connect.geant.org/wp-content/uploads/2020/02/SWITCH-Hack-The-Hacker-Banner-TNC20.jpg" className
                      ="d-block w-100" alt="..." />
                      <div className="carousel-caption d-none d-md-block">
                        <button type="button" className="btn btn-light px-4 py-2">تعرف على المزيد</button>
                      </div>
                          ...
                          return (
                            <div key={program.id} className="col-xl-4 col-md-6 p-3 rounded">
                              <a href="#" className="card bg-second border-0 text-white text-decoration-none">
                                ...
                                <div className="card-body d-flex flex-row-reverse justify-content-between program-text">
