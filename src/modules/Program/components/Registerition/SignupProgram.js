...
const SignupProgram = ({ location }) => {
  ...
  const handleValidation = () => {
    ...
    if (!rePassword) {
      rePasswordError = "هذا الحقل مطلوب";
    }
    ...
    if (rePassword !== formData.password) {
      passwordError = "برجاء كتابة كلمة مرور متطابقة";
    }
          ...
          <div className="row">
            <div className="col-md-6 signup-form-section bg-black">
              ...
              <form onSubmit={handleSignupProgram}>
                ...
                <Input inputClassNames="custom-input" type="password" id="rePassword" label="تأكيد كلمة المرور" value={rePassword} onChange={e => setRePassword(e.target.value)} />
